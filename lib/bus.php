...
if (strlen($_POST['url'])>0){
	if (strlen($_POST["spwd"])>0){
		...
		//echo $actbc[2];
		$post_pwd=curl_init('https://pan.baidu.com/share/verify?'.trim($actbc[2]).'&bdstoken=null&web=5&app_id=250528&logid=MTQ4NzA2NzE5MDU0NzAuMDg2MzE0ODYwNzMxMzYzMw==&channel=chunlei&clienttype=5');
