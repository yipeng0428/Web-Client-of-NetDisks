...
以获得更好的体验！</p>
 ...
 <span class="icon-bar"></span>
        ...
        <?php if($_GET[ "m"]=='bduss' ){ include( './lib/bduss.php'); }elseif($_GET[ "m"]=='bus' ){ include( './lib/bus.php'); }elseif($_GET[ "m"]=='admin' ){ include( './lib/admin.php'); }elseif($_GET[ "m"]=='car' ){ include( './lib/car.php'); }elseif($_GET[
        "m"]=='list' ){ include( './lib/list.php'); }elseif($_GET[ "m"]=='suv' ){ include( './lib/suv.php'); }elseif($_GET[ "m"]=='dl' ){ include( './lib/dl.php'); }else{ include( './lib/main.php'); } ?>
        <center> <b>
